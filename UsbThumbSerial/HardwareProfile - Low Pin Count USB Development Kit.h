...
#define HARDWARE_PROFILE_LOW_PIN_COUNT_USB_DEVELOPMENT_KIT_H
	...
	//_sb_ 
	// instead of controlling DTR pin dirrectly, output inverted value
	// set in USBCBCheckOtherReq(), main.c
	// thus the DTR pin becomes a _RESET pin needed for Proppeller programming
