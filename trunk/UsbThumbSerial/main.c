...
********************************************************************
 ...
 Change History:
  ...
  2.2 	01/09/2010 _sb_  Starlino Edit of Mircrochip CDC sample (Look for _sb_ marker in all files for my modifications)
	Enabled	hardware flow control, DTR pin is reversed and functions as a (_RESET) pin.  
	Thus, this device can be used to programm a Propeller chip.
********************************************************************/
char uart_dtr_placeholder;		//_sb_
...
void InitializeUSART(void)
{
		...
		#if defined(USB_CDC_SUPPORT_HARDWARE_FLOW_CONTROL)		//_sb_ ?
			UART_TRISRTS = 0;
			UART_TRISDTR = 0;
		#endif
...
void USBCBCheckOtherReq(void)
{
	...
	PORTBbits.RB6 =! uart_dtr_placeholder; 	//_sb_ output UART_DTR  reversed
